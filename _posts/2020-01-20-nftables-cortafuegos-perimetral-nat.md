...
Si desde intenet accedemos con un navegador web a la URL `http://80.56.1.14/` estaríamos accediendo al servidor web instalado en la máuina con IP `192.168.100.1`.
