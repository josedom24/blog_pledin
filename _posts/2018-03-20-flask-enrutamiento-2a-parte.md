...
![<img src="{{ site.url }}{{ site.baseurl }}/assets/wp-content/uploads/2018/03/ruta3.png" alt="" width="469" height="112" class="aligncenter size-full wp-image-1932" />]({{ site.url }}{{ site.baseurl }}/assets/wp-content/uploads/2018/03/ruta3.png) 
![<img src="{{ site.url }}{{ site.baseurl }}/assets/wp-content/uploads/2018/03/ruta4.png" alt="" width="1031" height="157" class="aligncenter size-full wp-image-1931" />]({{ site.url }}{{ site.baseurl }}/assets/wp-content/uploads/2018/03/ruta4.png)
...
![<img src="{{ site.url }}{{ site.baseurl }}/assets/wp-content/uploads/2018/03/ruta5.png" alt="" width="487" height="108" class="aligncenter size-full wp-image-1942" />]({{ site.url }}{{ site.baseurl }}/assets/wp-content/uploads/2018/03/ruta5.png)
...
![<img src="{{ site.url }}{{ site.baseurl }}/assets/wp-content/uploads/2018/03/ruta6.png" alt="" width="433" height="107" class="aligncenter size-large wp-image-1945" />]({{ site.url }}{{ site.baseurl }}/assets/wp-content/uploads/2018/03/ruta6.png)
![<img src="{{ site.url }}{{ site.baseurl }}/assets/wp-content/uploads/2018/03/ruta7.png" alt="" width="481" height="109" class="aligncenter size-full wp-image-1944" />]({{ site.url }}{{ site.baseurl }}/assets/wp-content/uploads/2018/03/ruta7.png) 
![<img src="{{ site.url }}{{ site.baseurl }}/assets/wp-content/uploads/2018/03/ruta8.png" alt="" width="507" height="114" class="aligncenter size-full wp-image-1943" />]({{ site.url }}{{ site.baseurl }}/assets/wp-content/uploads/2018/03/ruta8.png)
